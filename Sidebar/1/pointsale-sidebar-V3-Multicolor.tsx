    ...
    if (item.label === 'Themes' && !isCollapsed) {
      return (
        <div key="themes" className="px-3 py-2">
          <h3 className={`text-sm font-medium mb-2 whitespace-nowrap overflow-hidden ${isDarkMode ? 'text-gray-400' : 'text-gray-500'
            }`}>Themes</h3>
        ...
        <div className="flex flex-col h-full items-center">
          ...
          <div className="py-4">
            ...
            <button
              ...
              className={`p-2 rounded-lg transition-colors group ${isDarkMode ? 'hover:bg-gray-800' : 'hover:bg-gray-200'
                }`}
              title="Expand sidebar"
            >
              <PanelLeftOpen className={`w-5 h-5 ${isDarkMode ? 'text-gray-300 group-hover:text-gray-100' : 'text-gray-600 group-hover:text-gray-800'
                }`} />
            </button>
          </div>
          ...
          <div className={`flex-1 flex flex-col items-center overflow-y-auto overflow-x-hidden custom-scrollbar ${isDarkMode ? 'dark-mode' : 'light-mode'}`}>
            {/* Quick search */}
            <button
              className={`w-10 h-10 mt-4 rounded-lg flex items-center justify-center transition-colors group relative ${isDarkMode ? 'hover:bg-gray-800' : 'hover:bg-gray-200'
                }`}
              title="Quick search"
            >
              <Search className={`w-5 h-5 ${isDarkMode ? 'text-gray-300 group-hover:text-gray-100' : 'text-gray-600 group-hover:text-gray-800'
                }`} />
            </button>
            ...
            <div className="relative mt-2">
              <button
                className={`w-10 h-10 rounded-lg flex items-center justify-center transition-colors group relative ${isDarkMode ? 'hover:bg-gray-800' : 'hover:bg-gray-200'
                  }`}
                title="Inbox"
              >
                <Inbox className={`w-5 h-5 ${isDarkMode ? 'text-gray-300 group-hover:text-gray-100' : 'text-gray-600 group-hover:text-gray-800'
                  }`} />
              </button>
            ...
            <div className="relative mt-2">
              <button
                ...
                title="Notifications"
              >
                <Bell className={`w-5 h-5 ${isDarkMode ? 'text-gray-300 group-hover:text-gray-100' : 'text-gray-600 group-hover:text-gray-800'
                  }`} />
              </button>
            ...
            {/* Pro trial icon */}
            <div
              className={`w-10 h-10 mt-4 rounded-lg flex items-center justify-center cursor-pointer transition-colors group ${isDarkMode ? 'bg-blue-950 hover:bg-blue-900' : 'bg-blue-100 hover:bg-blue-200'
                }`}
        ...
        <>
          ...
          <div className={`p-4 border-b ${isDarkMode ? 'border-gray-700' : 'border-gray-200'}`}>
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <span className={`font-semibold whitespace-nowrap overflow-hidden ${isDarkMode ? 'text-gray-50' : 'text-gray-900'
                  }`}>Pointsale</span>
              </div>
              <div className="flex items-center space-x-2">
                <button
                  onClick={toggleSidebar}
                  className={`p-1 rounded transition-colors group ${isDarkMode ? 'hover:bg-gray-800' : 'hover:bg-gray-100'
                    }`}
                  title="Collapse sidebar"
                >
                  <PanelLeftOpen className={`w-5 h-5 ${isDarkMode ? 'text-gray-400 group-hover:text-gray-200' : 'text-gray-400 group-hover:text-gray-600'
                    }`} />
                </button>
              </div>
            </div>
          ...
          <div className={`flex-1 overflow-y-auto custom-scrollbar ${isDarkMode ? 'dark-mode' : 'light-mode'}`}>
            ...
            <div className={`px-4 py-3 border-b ${isDarkMode ? 'border-gray-700' : 'border-gray-200'}`}>
              <div className={`flex items-center space-x-3 px-3 py-2 rounded-lg cursor-pointer transition-colors ${isDarkMode ? 'text-gray-300 hover:bg-gray-800 hover:text-white' : 'text-gray-600 hover:bg-gray-100'
                }`}>
            ...
            <div className={`border-b ${isDarkMode ? 'border-gray-700' : 'border-gray-200'}`}>
              ...
              <div className={`flex items-center justify-between px-3 py-2 mx-4 cursor-pointer transition-colors rounded-lg ${isDarkMode ? 'hover:bg-gray-800' : 'hover:bg-gray-100'
                }`}>
                <div className="flex items-center space-x-3 min-w-0">
                  <Inbox className={`w-5 h-5 flex-shrink-0 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`} />
                  <span className={`whitespace-nowrap overflow-hidden ${isDarkMode ? 'text-gray-50' : 'text-gray-900'
                    }`}>Inbox</span>
                </div>
                <span className={`text-sm px-2 py-1 rounded font-medium flex-shrink-0 ${isDarkMode ? 'bg-red-600 text-white' : 'bg-gray-100 text-gray-700'
                  }`}>12</span>
              </div>
            ...
            {/* Menu section */}
            <div className="p-4">
              <h3 className={`text-sm font-medium mb-4 whitespace-nowrap overflow-hidden ${isDarkMode ? 'text-gray-400' : 'text-gray-500'
                }`}>Menu</h3>
            ...
            <div className="p-4">
              <div className={`rounded-xl p-4 border overflow-hidden ${getUpgradeSectionClasses()}`}>
                <div className="flex items-center space-x-3 mb-3">
                  <div className={`w-8 h-8 rounded-lg flex items-center justify-center shadow-sm flex-shrink-0 ${isDarkMode ? 'bg-blue-900' : 'bg-white'
                    }`}>
                    <Star className={`w-4 h-4 ${isDarkMode ? `text-${themeColor}-400` : `text-${themeColor}-600`} transition-colors`} />
                  </div>
                  <div className="min-w-0">
                    <div className={`text-sm whitespace-nowrap overflow-hidden ${isDarkMode ? 'text-gray-400' : 'text-gray-600'
                      }`}>Current plan:</div>
                    <div className={`font-semibold whitespace-nowrap overflow-hidden ${isDarkMode ? 'text-gray-50' : 'text-gray-900'
                      }`}>Pro trial</div>
                  </div>
                </div>

                <p className={`text-sm mb-4 overflow-hidden ${isDarkMode ? 'text-gray-300' : 'text-gray-600'
                  }`}>
                  Upgrade to Pro to get the latest and exclusive features
                </p>

                <button className={`w-full font-medium py-2 px-4 rounded-lg flex items-center justify-center space-x-2 transition-colors ${isDarkMode ? `bg-${themeColor}-500 hover:bg-${themeColor}-600 text-white` : `bg-${themeColor}-600 hover:bg-${themeColor}-700 text-white`
                  }`}>
          ...
          <div className={`border-t p-4 ${isDarkMode ? 'border-gray-700' : 'border-gray-200'}`}>
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3 min-w-0">
                ...
                <div className="min-w-0">
                  <div className={`font-medium whitespace-nowrap overflow-hidden ${isDarkMode ? 'text-gray-50' : 'text-gray-900'
                    }`}>Brooklyn</div>
                  <div className={`text-sm whitespace-nowrap overflow-hidden ${isDarkMode ? 'text-gray-400' : 'text-gray-500'
                    }`}>Pro trial</div>
                </div>
              </div>
              <ChevronUp className={`w-5 h-5 flex-shrink-0 ${isDarkMode ? 'text-gray-400' : 'text-gray-400'
                }`} />
            </div>
          </div>
        </>
